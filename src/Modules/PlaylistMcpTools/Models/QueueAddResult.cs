...
///
/// <para><see cref="QueueLength"/> counts the tracks waiting after the add, not the one playing
/// now. <see cref="FirstAddedPosition"/> is where the first added track landed, counting from 1
/// for the track that plays next. It exists because a caller that has just queued something
